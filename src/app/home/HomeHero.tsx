  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-sky-100">
      ...
      <div
        ...
        style={{ backgroundColor: "rgba(2, 1, 1, 0)" }}
      />
      ...
      <div className="relative z-20 mx-auto flex min-h-screen w-full max-w-[1150px] flex-col items-center px-5 text-center">
        ...
        <a
          href="/shop"
          className="bayblaze-hero-button mt-[33px] rounded-[3px] bg-[var(--ast-global-color-0)] px-5 py-2.5 text-center text-white transition-colors hover:bg-black"
        >
          SHOP
        </a>
      </div>
